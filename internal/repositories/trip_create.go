...
func (r *RepoPg) Create(ctx context.Context, tx pgx.Tx, tr *domain.Trip) error {
	_, err := tx.Exec(
		ctx,
		`INSERT INTO trips(id, driver_id, from_point, to_point, departure_time, seats, status, created_at, version) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9)`,
		tr.Id, tr.DriverId, tr.FromPoint, tr.ToPoint, tr.DepartureTime, tr.Seats, tr.Status, tr.CreatedAt, tr.Version,
	)
	if err != nil {
